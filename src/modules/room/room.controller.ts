...
export const getSingleRoom:RequestHandler = catchAsync(async(req,res)=>{
...
export const updateRoom: RequestHandler = catchAsync(async (req, res) => {
...
export const deleteRoom: RequestHandler = catchAsync(async (req, res) => {
